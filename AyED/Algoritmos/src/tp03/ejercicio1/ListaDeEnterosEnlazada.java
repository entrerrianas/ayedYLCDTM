...
public class ListaDeEnterosEnlazada extends ListaDeEnteros {
	...
	public void comenzar() {
		actual = inicio; // Pone el puntero actual en el primer elemento de la lista
	}

	@Override
	public Integer proximo() { // se posiciona en el siguiente y retorna el dato del anterior a ese
	...
	public boolean eliminar(Integer elem) {
		...
		if (n == null)
			...
			if (ant == null)
				// inicio deberia ser n.getSiguiente() 
				inicio = null; // Consultar: No se esta perdiendo el inicio de la lista???? 
			else
