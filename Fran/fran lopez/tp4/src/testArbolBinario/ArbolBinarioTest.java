...
public class ArbolBinarioTest {
	...
	public void testFrontera() {
		...
		System.out.println("Arbol B (lista esperada) : " + listaFronteraEsperada.toString());
		...
		System.out.println("Lista frontera : " + listaFronteraDeArbolBinario.toString());
		
		listaFronteraEsperada.agregarEn(13,1);
		listaFronteraEsperada.agregarEn(14,2);
		listaFronteraEsperada.agregarEn(8,3);
		
		System.out.println("Arbol C (lista esperada) : " + listaFronteraEsperada.toString());
